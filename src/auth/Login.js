      ...
      <div className="container">
        <div className="form-group">
          ...
          <form className="form-group__form js-form-login" action="#">
            <input defaultValue="demo@vnext.com.vn" className="form__input" type="email" placeholder={ja.email} required onChange={e => { setEmail(e.target.value); setStatusLogin('') }} />
            <input defaultValue="123456" className="form__input" type="password" placeholder={ja.password} required onChange={e => { setPassword(e.target.value); setStatusLogin('') }} />
